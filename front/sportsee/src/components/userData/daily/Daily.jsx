...
function Chart({ userActivityData }) {
    ...
    return (
        <div className="activityChart">
            <ResponsiveContainer >
                ...
                <YAxis yAxisId={'right'} tickCount={3}  domain={['dataMin -1' , 'dataMax' ]} tickLine={false} axisLine={false} orientation="right"  tick={{fill:"#9B9EAC", fontWeight:500, fontSize:14}} tickMargin={45} minTickGap={27}/>

                <Tooltip content={<CustomTooltip />} wrapperStyle={{width: "2.44rem", height: "3.94rem", outline: "none", backgroundColor: "#FF0000", fontSize:"10px", color:"white", textAlign:"center"}} />
                ...
                <Bar yAxisId={'left'} dataKey={"calories"}  name="Calories brulées (kCal)" fill="#E60000" radius={[3, 3, 0, 0]}  />
