		...
		<div style={{ minWidth: "258px", height: "263px", backgroundColor: "#FBFBFB", borderRadius: "5px",}}>
			<ResponsiveContainer>
				<PieChart width={50} height={50}>
					<Pie data={data} dataKey="value" cx="50%" cy="50%" startAngle={170} endAngle={170 - (mainData.scorePourcent * 360) / 100} innerRadius={80} outerRadius={90} fill="#FF0000" cornerRadius={5}/>	
					<Pie data={data} dataKey={"value"} cx="50%" cy="50%" startAngle={170} endAngle={-190} innerRadius={0} outerRadius={80} fill="white"/>
					<text x={20} y={50}>Score</text>
